...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Roodepoort Tree Felling",
    phone:     "011 595 4876",
    whatsapp:  "011 595 4876",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Roodepoort Tree Felling — Tree felling in roodepoort",
    description: "Roodepoort Tree Felling provides professional tree felling in Roodepoort. 1 Google review. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Tree felling · Roodepoort & surrounds",
    heroTitle:  "Safe tree felling — <em>from assessment to clean-up.</em>",
    heroLead:   "Roodepoort Tree Felling handles tree felling, stump removal and trimming across Roodepoort and the surrounding suburbs. Professional equipment, safe teams, clean site.",
    ...
    band: {
      ...
      alt:   "Roodepoort Tree Felling team at work in Roodepoort",
      text:  "Safe, efficient tree felling — from assessment to clean-up."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Roodepoort. Covering the wider area.",
    areasLead:  "We work across Roodepoort, Florida, Weltevreden Park and the surrounding suburbs. Emergency callouts for storm damage handled as quickly as possible.",
